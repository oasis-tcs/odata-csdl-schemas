...
module.exports.xml2json = function (
  ...
  preParser.onopentag = function (node) {
    ...
    switch (node.local) {
      ...
      case "DataServices": {
        ...
        //TODO: check XML namespace in attr.uri if version < 4.0
        break;
      }
      case "Reference":
  ...
  const SCHEMA = {
    ...
    Schema: {
      ...
      // V2/V3
      Association: { min: 0 },
      //TODO: Using -> Reference with dummy Uri + Include
      //TODO: ValueTerm -> Term
    },
    Annotations: {
      v2x: true,
      Annotation: { min: 0 },
      // V3
      //TODO: TypeAnnotation -> Annotation + Record
  ...
  parser.onopentag = function (node) {
    ...
    switch (node.local) {
      ...
      case "EntityType":
        ...
        if (result.$Version < "4.0") {
          //TODO: check XML namespace in attr.uri
