...
module.exports.xml2json = function (
  ...
  function v2PropertyAnnotations(target, node) {
    ...
    for (const attribute of Object.values(node.attributes)) {
      ...
      switch (attribute.local) {
        ...
        case "validation-regexp":
          target[`@${alias.Validation}.Pattern`] = attribute.value;
    ...
    if (!creatable && !updatable) target[`@${alias.Core}.Computed`] = true;
    if (creatable && !updatable) target[`@${alias.Core}.Immutable`] = true;
    //TODO: filterable, sortable, required-in-filter, filter-restrictions,
  }
