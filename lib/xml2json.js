    ...
    parser.onopentag = function (node) {
        ...
        switch (node.local) {
            case 'Reference': {
                ...
                if ((uri.startsWith('https://oasis-tcs.github.io/odata-vocabularies/vocabularies/')
                    || uri.startsWith('https://sap.github.io/odata-vocabularies/vocabularies/')) && uri.endsWith('.xml'))
