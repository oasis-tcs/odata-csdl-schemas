...
module.exports.xml2json = function (
  ...
  const preV4 = {
    ...
    needs: { Core: false, Capabilities: false },
  };
  ...
  addAlias(alias, "Org.OData.Core.V1", "Core");
  addAlias(alias, "Org.OData.Capabilities.V1", "Capabilities");
  ...
  function v2Annotations(target, node, annotationsMap) {
    ...
    for (const attribute of attributes) {
      ...
      for (const b of becomes) {
        target[`@${alias[anno.vocabulary]}.${b.term}`] =
  ...
  //TODO: extract function or loop over preV4.needs
  if (preV4.needs.Core && namespace["Org.OData.Core.V1"] === undefined) {
    if (!result.$Reference) result.$Reference = {};
    result.$Reference[
  ...
  if (
    preV4.needs.Capabilities &&
    namespace["Org.OData.Capabilities.V1"] === undefined
  ) {
    if (!result.$Reference) result.$Reference = {};
...
function addAlias(aliasMap, namespace, alias) {
  if (!aliasMap[namespace]) {
    aliasMap[namespace] = alias;
