...
describe('Examples', function () {
    ...
    it('csdl-16.1', function () {
        assert.deepStrictEqual(xml2json(example1), result1);
    })

    it('csdl-16.2', function () {
        assert.deepStrictEqual(xml2json(example2), result2);
    })

    it('miscellaneous', function () {
        assert.deepStrictEqual(xml2json(example3), result3);
    })

    it('miscellaneous2', function () {
        assert.deepStrictEqual(xml2json(example4), result4);
    })
